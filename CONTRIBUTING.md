...
for pkg in packages/{gleam_analysis,gleam_hub,gleam_ir,gleam_parser,jev,topological,touch_grass,untethered}; do
...
```sh
for pkg in packages/{gleam_analysis,gleam_cli,gleam_compiler,gleam_hub,gleam_interpreter,gleam_ir,gleam_parser,gleam_x,jev,morph,topological,touch_grass,untethered,website}; do
